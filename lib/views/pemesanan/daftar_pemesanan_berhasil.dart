...
class DaftarPemesananBerhasil extends StatefulWidget {
  const DaftarPemesananBerhasil({Key key}) : super(key: key);

  @override
  _DaftarPemesananBerhasilState createState() =>
      _DaftarPemesananBerhasilState();
}

class _DaftarPemesananBerhasilState
    extends State<DaftarPemesananBerhasil> {
  @override
  Widget build(BuildContext context) {
    return BaseView<PemesananProvider>(
      onModelReady: (model)=>model.getDaftarPemesanan(status: 'berhasil'),
      builder: (context, provider, child) {
        return provider.state == ViewState.Fetching
            ...
            : provider.state == ViewState.FetchNull
                ...
                : RefreshIndicator(
                  onRefresh: () => provider.getDaftarPemesanan(status: 'berhasil'),
                  child: Container(
